...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        },
        {
          name: "Mike Ross",
          handle: "@mross",
          testimonial: "Unmatched attention to detail and personalized service.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-young-businessman-talking-mobile-phone-with-wireless-earphone-his-ears_23-2148176222.jpg",
        },
      ]}
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/woman-white-shirt-showing-emotions-blue_1303-29741.jpg",
          alt: "Client profile",
        },
        {
      ...
      marqueeItems={[
        ...
        {
          type: "text",
          text: "Certified Safety Standards",
        },
        {
          type: "text",
          text: "Luxury Fleet Access",
        },
        {
          type: "text",
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        ...
        {
          type: "image",
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/a-luxury-interior-of-a-private-jet-showi-1778092438092-cc092b53.png",
          alt: "Jet Interior",
        },
        {
          type: "text",
          content: " the art of travel.",
        },
      ]}
    />
  </div>
      ...
      products={[
        {
          ...
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/gulfstream-g650-parked-at-a-hangar-sharp-1778092450668-086c7add.png",
        },
        {
          id: "p2",
          name: "Falcon 8X",
          price: "Contact for pricing",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/falcon-8x-in-mid-flight-against-a-clear--1778092459301-c57fa373.png",
        },
        {
          id: "p3",
          name: "Bombardier Challenger",
          price: "Contact for pricing",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/challenger-jet-on-airfield-1778092469052-c650aceb.png",
        },
        {
          id: "p4",
          name: "Citation Latitude",
          price: "Contact for pricing",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/citation-latitude-taxiing-1778092480323-6c464920.png",
        },
        {
          id: "p5",
          name: "Embraer Phenom 300",
          price: "Contact for pricing",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/embraer-jet-parked-1778092492236-10ce5273.png",
        },
        {
          id: "p6",
          name: "Legacy 650",
          price: "Contact for pricing",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DLNLdVpFHmbbI9nuxPgilzABGs/legacy-650-luxury-jet-1778092501170-79559561.png",
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m2",
          value: "20K+",
          title: "Safe Flight Hours",
          description: "Experienced crews",
          icon: ShieldCheck,
        },
        {
          id: "m3",
          ...
          description: "Reliable schedules",
          icon: Clock,
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",
          title: "How do I book a jet?",
          content: "You can contact our concierge team at any time via phone or email.",
        },
        {
          id: "f2",
          title: "Are there luggage restrictions?",
          content: "Each aircraft type has specific baggage capacities; we will guide you through this during booking.",
        },
        {
          id: "f3",
          title: "Can I bring pets?",
          content: "Yes, we are pet-friendly and offer dedicated services for your furry friends.",
        },
      ]}
