...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        { name: "Sarah Lee", handle: "@slee", testimonial: "AeroElite is my go-to choice for all business travel.", rating: 5, imageSrc: "https://img.b2bpic.net/free-photo/pretty-attractive-young-mixed-race-model-with-large-afro-wearing-navy-jacket-her-naked-body-shorts_633478-1216.jpg?_wi=1" },
